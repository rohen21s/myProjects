...
public class TagsModificaFiltre extends javax.swing.JFrame {

    /**
     * Creates new form EmpresesModificaFiltre
     */
    public TagsModificaFiltre() {
        initComponents();
        emplenarTaula();
        ...
        if (contTags == 0) {
            missatgeModifErr("No hi han categories per modificar!", "GestioCategories - Modifica");
        }
    }
    
    //Metode per crear missatges/alertes.
    public void missatgeModifErr (String missatge, String titol){
    ...
    private void initComponents() {
        ...
        idModiFiltre = new javax.swing.JTextField();
        ...
        jLabel1.setText("Quina categoria vols modificar, introdueix la ID:");

        idModiFiltre.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                idModiFiltreActionPerformed(evt);
            }
        });
        ...
        Info1.setText("MODIFICA LA CATEGORIA");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(idModiFiltre, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(idModiFiltre, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void idModiFiltreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_idModiFiltreActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_idModiFiltreActionPerformed
    ...
    private void confirmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmaActionPerformed
        ...
        try {
            ...
            //Condicio 1
            if (contTags == 0) {
                //ALERTA: No hi han categories per modificar.
                missatgeModifErr("No hi han categories per modificar.", "GestioCategories - Modifica");

                //Condicio 2
            } else if (numIntroduit > contTags - 1) {
                //ALERTA: La categoria que vols modificar no existeix.
                missatgeModifErr("La categoria que vols modificar no existeix.", "GestioCategories - Modifica");

                //Condicio final MODIFICAR
            } else {

                TagsModifica Xempresa = new TagsModifica();
                Xempresa.setVisible(true);
                dispose();
        ...
        //CONTROL DE ERRORS / EXCEPCIONS
            ...
            JOptionPane.showMessageDialog(new JFrame(), "Introdueix correctament la ID per MODIFICAR.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TagsModificaFiltre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TagsModificaFiltre().setVisible(true);
            }
        });
    }
    
    //Metode que retorna una ID.
    public static int getFiltre() {
        return Integer.parseInt(idModiFiltre.getText());
    }
    
    //Metode per consultar dins d'un input
    ...
    // Plena la taula amb les categories de l'array
    ...
    private static javax.swing.JTextField idModiFiltre;
    private javax.swing.JLabel info1;
